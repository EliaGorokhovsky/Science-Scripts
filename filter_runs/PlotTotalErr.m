...
%
% DART $Id: PlotTotalErr.m 12753 2018-07-18 18:01:52Z jla@ucar.edu $
...
num_to_skip = 500;
   ...
   case {'simple_advection'}
      % Change this to change the number of variables being observed, but make sure to update the automation script as well so it can read the data properly
      varlist = {'concentration', 'wind'};
      ...
      for ivar = 1:length(varlist)
        ...
        fid_out = fopen('rms_spread_out', 'a');
        fprintf(fid_out, '%11.6f,%11.6f,', errTotal ./ sqrt(40), spreadTotal ./ sqrt(40));
        fclose(fid_out);
...
% $URL: https://svn-dares-dart.cgd.ucar.edu/DART/branches/concentration_observations/diagnostics/matlab/private/PlotTotalErr.m $
% $Revision: 12753 $
% $Date: 2018-07-18 12:01:52 -0600 (Wed, 18 Jul 2018) $
